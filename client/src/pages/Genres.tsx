    ...
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="flex-1 md:ml-64">
        ...
        <main className="p-4 md:p-8 md:pt-6">
          ...
          {/* Genre Breakdown Section - Full View */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Your Genre Breakdown</h2>
            <Suspense fallback={<LoadingSpinner message="Analyzing your genres..." />}>
              <GenreBreakdownSection fullView={true} />
            </Suspense>
          </section>
        </main>

        {/* Mobile Navigation */}
        <MobileNav activePage="genres" />
      </div>
    </div>
  );
}
